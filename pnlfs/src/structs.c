...
struct pnlfs_inode	foo;
struct pnlfs_inode_info	foo1;
struct pnlfs_superblock foo2;
struct pnlfs_sb_info	foo3;
struct pnlfs_file_index_block foo4;
struct pnlfs_dir_block	foo5;
